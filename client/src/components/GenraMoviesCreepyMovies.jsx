...
const GenraMoviesCreepyMovies = () => {
  const navigate = useNavigate();

  // Creepy movies data
  const creepyMovies = [
    { 
      id: 1, src: assets.lighthouse, title: "The Lighthouse", rating: "7.4", year: "2019",
      description: "Two lighthouse keepers descend into madness on a remote, storm-battered island.",
      platforms: ["Amazon Prime", "Hulu"],
      trailer: "Hyag7lR8CPA"
    },
    { 
      id: 2, src: assets.lightsout, title: "Lights Out", rating: "6.3", year: "2016",
      description: "A woman and brother face a supernatural entity that attacks in darkness..",
  ...
  const platformLogos = {
    ...
    "Shudder": "https://logos-world.net/wp-content/uploads/2021/08/Shudder-Logo.png"
  };
      ...
      <div className="relative z-10 pt-8 pb-12">
        ...
        <div className="text-center">
          ...
          <p className="text-white/80 text-lg md:text-xl font-light tracking-wide">
            Unsettling films that linger in your mind
          </p>
              ...
              >
                ...
                >
                  ...
                  <div className="absolute top-4 left-4 bg-black/70 backdrop-blur-sm px-3 py-1 rounded-full border border-purple-400/30">
                    <span className="text-purple-400 text-sm font-medium">{movie.year}</span>
                  </div>
                </div>
...
export default GenraMoviesCreepyMovies;