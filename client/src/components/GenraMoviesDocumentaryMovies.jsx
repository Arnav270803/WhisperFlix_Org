...
const GenraMoviesDocumentaryMovies = () => {
  const navigate = useNavigate();

  // Documentary movies data
  const documentaryMovies = [
    { 
      id: 1, src: assets.fordvsfararri, title: "The Social Dilemma", rating: "8.1", year: "2019",
     ...
     { 
         id: 2, src: assets.Grandturismo, title: "Grand Turismo", rating: "7.1", year: "2023",
         description: "Gamer transitions to professional racing, facing high-stakes challenges at Le Mans.",
         platforms: ["Amazon Prime", "Netflix"],
         trailer: "https://www.youtube.com/watch?v=GVPzGBvPrzw&t=9s"
       },
   
       { 
         id: 4, src: assets.myoldschool, title: "My Old School", rating: "7.0", year: "2022",
         description: "A therapist's life unravels after a murder shocks her elite circle.",
         platforms: ["Amazon Prime", "Hulu"],
         trailer: "https://www.youtube.com/watch?v=DDazGVIs9C0"
       },
       { 
         id: 5, src: assets.searchingforsugarman, title: "Searching for Sugar Man", rating: "8.2", year: "2022",
         description: "Description: Two fans search for a mysterious 1970s musician, uncovering his global impact.",
         platforms: ["Amazon Prime", "Netflix"],
         trailer: "https://www.youtube.com/watch?v=KKXewWDh1og"
       },
       { 
         id: 6, src: assets.shinkers, title: "Shinkers", rating: "7.3", year: "2018",
         description: "A filmmaker investigates her stolen 1992 indie film footage, unraveling a mystery.",
         platforms: ["Netflix"],
         trailer: "https://www.youtube.com/watch?v=u3wPWCj2L6I"
       },
       { 
         id: 7, src: assets.theactofkilling, title: "The Act of Killing", rating: "8.2", year: "2012",
         description: "A financial planner gets entangled with a drug cartel.",
         platforms: ["Netflix","Amazon Prime"],
         trailer: "https://www.youtube.com/watch?v=n_cXCOBcH5c"
       },
       { 
        ...
        { 
         id: 8, src: assets.unrest, title: "Unrest", rating: "757", year: "2017",
         description: "A bedridden PhD student documents her chronic fatigue syndrome, advocating for millions.",
         platforms: ["Youtube","netflix"],
         trailer: "https://www.youtube.com/watch?v=JvK5s9BNLzA"
       }
  ];
      ...
      <div className="relative z-10 pt-8 pb-12">
        ...
        <div className="text-center">
          ...
          <p className="text-white/80 text-lg md:text-xl font-light tracking-wide">
            Real-world stories that inform and inspire
          </p>
              ...
              >
                ...
                >
                  ...
                  <div className="absolute top-4 left-4 bg-black/70 backdrop-blur-sm px-3 py-1 rounded-full border border-yellow-400/30">
                    <span className="text-yellow-400 text-sm font-medium">{movie.year}</span>
                  </div>
                </div>
...
export default GenraMoviesDocumentaryMovies;