...
const GenraMoviesAdventureMovies = () => {
  const navigate = useNavigate();

  // Adventure movies data
  const adventureMovies = [
    { 
      id: 1, src: assets.bladerunner  , title: "Blade Runner", rating: "8.1", year: "2017",
      description: "Blade Runner hunts rogue replicants in a dystopian future.",
      platforms: ["Max", "Amazon Prime"],
      trailer: "https://www.youtube.com/watch?v=txx8E9s8iEs"
    },
    { 
      id: 2, src: assets.Rimoftheworldjpeg, title: "Rim of the World", rating: "5.2", year: "2019",
      description: "Four misfit campers unite to save the world during an alien invasion.",
      platforms: ["Netflix"],
      trailer: "https://www.youtube.com/watch?v=xkvBpKHL99k"
    },
    { 
      id: 3, src: assets.thegift, title: "The Gift", rating: "7.0", year: "2015",
      description: "A couple’s life unravels when a mysterious acquaintance reveals unsettling secrets.",
      platforms: ["Netflix", "Prime Video","Hulu"],
      trailer: "https://www.youtube.com/watch?v=I3IiZU9JBuE"
    },
    { 
      id: 4, src: assets.themazerunner, title: "The Maze Runner", rating: "6.8", year: "2014",
    ...
    { 
      id: 5, src: assets.Twisters, title: "Twisters", rating: "6.7", year: "2024",
      description: "Storm chasers unite to track and survive converging tornadoes in Oklahoma.",
      platforms: ["anetflix", "Amazon Prime"],
      ...
      <div className="relative z-10 pt-8 pb-12">
        ...
        <div className="text-center">
          ...
          <p className="text-white/80 text-lg md:text-xl font-light tracking-wide">
            Epic films that take you on thrilling journeys
          </p>
              ...
              >
                ...
                >
                  ...
                  <div className="absolute top-4 left-4 bg-black/70 backdrop-blur-sm px-3 py-1 rounded-full border border-green-400/30">
                    <span className="text-green-400 text-sm font-medium">{movie.year}</span>
                  </div>
                </div>
...
export default GenraMoviesAdventureMovies;